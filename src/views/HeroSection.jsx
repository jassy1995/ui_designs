    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10'>
            <div className='bg-[rgb(20,22,28)] rounded-md p-12 flex flex-col justify-center items-center'>
                ...
                <p className='text-slate-300 mt-6'>Make a good impression when you communicate your identity and the service or products you sell to your audience.</p>
            </div>
            <div className='bg-[rgb(20,22,28)] rounded-md p-12 flex flex-col justify-center items-center'>
...
export default function HeroSection() {
    return (
        <div className="bg-[rgb(25,27,32)] px-4 sm:px-20 md:px-32 py-10 text-white relative">
            <HeaderNavigation />
            <div className="hidden sm:block absolute z-0 w-[10%] h-[35%] left-[200px] top-[70px] blue__gradient_1" />
            ...
            <div className='flex space-x-3 mt-20 md:mt-32'>
                <div className='flex flex-col  md:w-1/2'>
                    <div className='flex flex-col'>
                        <h4 className='tracking-wide uppercase z-10 text-slate-300'>a trusted digital agency 😍</h4>
                        <h1 className='text-7xl font-bold z-10'>we make your business look amazing</h1>
                    </div>
                    <p className='max-w-[500px] mt-6 z-10 text-slate-300'>Enver studio is a didgital studio that offers several services such as UI/UX Design to developers, we will provide the best services for those of you who use our service</p>
                    <div className='flex items-center space-x-5 mt-9 z-10'>
                        ...
                        <div className='flex items-center space-x-2'>
                            ...
                            <span className='text-slate-300 font-bold'>See our project</span>
                            <MdArrowForward />
                        </div>
                    </div>
